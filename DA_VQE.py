"""
This code is created for the IQM hackathon challenge.
https://github.com/iqm-finland/iqm-academy-womanium-hackathon-DAQC-VQE
Some of the codes are taken and modified from qiskit-tutorial and Stefan Seegerer

Atsushi Ueda(@dartsushi) Prashant Sharma(@nanophile)
"""
